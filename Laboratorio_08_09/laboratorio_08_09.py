...
##4. Asegurar que una lista no esté vacía. 
    ...
    try:
        ...
        asegurar_lista_no_vacia(numeros)
...
# sdfsdfsd
    ...
    def buscar(self, dato):
        """
        Método para buscar un dato específico en la lista enlazada.
        """
        actual = self.inicio  # Comenzamos desde el primer nodo de la lista
        while actual:
            if actual.dato == dato:  # Si el dato del nodo actual coincide con el dato buscado
                return True  # Se encontró el dato, devolvemos True
            actual = actual.siguiente  # Avanzamos al siguiente nodo
        return False  # Si el dato no se encuentra en la lista, devolvemos False

    # Suma de Nodos
    # 11. Implementa una función que sume todos los nodos de una lista enlazada simple.
def suma_todos_nodos(self):
    """
    Método para calcular la suma de todos los datos almacenados en los nodos de la lista enlazada.
    """
    suma = 0  # Inicializamos la suma en 0
    actual = self.inicio  # Comenzamos desde el primer nodo de la lista
    while actual:
        suma += actual.dato  # Sumamos el dato del nodo actual a la suma total
        actual = actual.siguiente  # Avanzamos al siguiente nodo
    return suma  # Devolvemos la suma total de todos los datos de la lista enlazada
...
def longitud(self):
    ...
    actual = self.inicio  # Comenzamos desde el primer nodo de la lista
    while actual:
        contador += 1  # Incrementamos el contador en 1 por cada nodo visitado
        actual = actual.siguiente  # Avanzamos al siguiente nodo
    return contador  # Devolvemos el contador, que representa la longitud de la lista enlazada
...
def concatenar(self, otra_lista):
    """
    Método para concatenar otra lista enlazada al final de la lista actual.
    """
    actual = self.inicio  # Comenzamos desde el primer nodo de la lista actual
    if actual is None:  # Si la lista actual está vacía
        self.inicio = otra_lista.inicio  # Asignamos el inicio de la lista actual al inicio de la otra lista
        return  # Terminamos la ejecución del método
    while actual.siguiente:
        # Avanzamos al último nodo de la lista actual
        actual = actual.siguiente
    actual.siguiente = otra_lista.inicio  # Concatenamos el inicio de la otra lista al último nodo de la lista actual
...
def eliminar_duplicados(self):
    """
    Método para eliminar los nodos duplicados de la lista enlazada.
    """
    if self.inicio is None:  # Si la lista está vacía
        return  # No hay nodos para eliminar, terminamos la ejecución del método
    valores_vistos = set()  # Creamos un conjunto para almacenar los valores que hemos visto
    actual = self.inicio  # Comenzamos desde el primer nodo de la lista
    valores_vistos.add(actual.dato)  # Agregamos el dato del primer nodo al conjunto
    while actual.siguiente:  # Mientras haya un siguiente nodo en la lista
        if actual.siguiente.dato in valores_vistos:  # Si el dato del siguiente nodo ya ha sido visto
            actual.siguiente = actual.siguiente.siguiente  # Eliminamos el siguiente nodo
        else:
            valores_vistos.add(actual.siguiente.dato)  # Agregamos el dato del siguiente nodo al conjunto
            actual = actual.siguiente  # Avanzamos al siguiente nodo
...
def invertir_orden(self):
    """
    Método para invertir el orden de los nodos en la lista enlazada.
    """
    anterior = None  # Inicializamos el nodo anterior como None
    actual = self.inicio  # Comenzamos desde el primer nodo de la lista
    siguiente = None  # Inicializamos el nodo siguiente como None
    while actual:  # Mientras haya un nodo actual en la lista
        siguiente = actual.siguiente  # Guardamos el nodo siguiente antes de modificarlo
        actual.siguiente = anterior  # Invertimos la dirección del puntero del nodo actual hacia el anterior
        anterior = actual  # Movemos el puntero anterior al nodo actual
        actual = siguiente  # Movemos el puntero actual al nodo siguiente
    self.inicio = anterior  # Actualizamos el inicio de la lista al último nodo, que ahora es el primero
